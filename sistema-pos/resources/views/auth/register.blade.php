...
<head>
    ...
    <title>Registro Staff | Poss Atelier</title>
    ...
    <style>
        ...
        .field-label { font-size: 11px; letter-spacing: .12em; color: #a1a1aa; text-transform: uppercase; margin-bottom: 6px; }
        .field-input {
            width: 100%;
            border: none;
        ...
        .small-note { margin-top: 14px; text-align: center; font-size: 11px; letter-spacing: .08em; color: #9ca3af; text-transform: uppercase; }
            ...
            <div class="login-content">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div style="margin-top: 16px;">
                        ...
                        @error('password_confirmation') <p class="alert">{{ $message }}</p> @enderror
                    </div>

                    <button type="submit" class="sign-btn">Registrarme</button>

                    <p class="small-note">¿Ya tienes cuenta? <a href="{{ route('staff.login') }}" style="color:#6b7280; text-decoration:none;">Inicia sesión</a></p>
                </form>
            </div>
        </div>
    </div>
